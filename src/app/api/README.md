...
- `GET /api/ugc?productId=...` - approved UGC media for a product
- `POST /api/ugc` - submit UGC media (requires session; pending moderation)
- `GET /api/ugc/my` - current user UGC submissions and statuses
- `GET /api/admin/ugc/pending` - admin pending UGC queue
- `PATCH /api/admin/ugc/[id]` - admin approve/reject UGC media
