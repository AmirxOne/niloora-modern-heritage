    ...
    <PageTransition>
      <div className="pt-6 md:pt-8">
        <section className="relative flex min-h-[70vh] items-center justify-center overflow-hidden">
          ...
          <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1 }} className="relative z-10 mx-auto max-w-3xl px-4 text-center">
        ...
        <section id="craftsmanship" className="bg-matte-elevated/50 py-24 md:py-32">
          <div className="site-container">
            ...
            <div className="space-y-8">
              {fa.about.steps.map((step, i) => (
                <ScrollReveal key={step.title} delay={i * 0.1}>
                  <motion.div whileHover={{ x: -8 }} transition={{ duration: 0.4 }} className="flex gap-8 rounded-sm border border-subtle bg-matte-elevated p-8 md:gap-12">
        ...
        <section className="py-24 text-center">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mx-auto max-w-2xl px-4">
