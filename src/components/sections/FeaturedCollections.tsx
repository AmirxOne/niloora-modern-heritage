          ...
          {isLoading
            ? Array.from({ length: 3 }).map((_, idx) => (
                <div key={idx} className="heritage-frame overflow-hidden" aria-busy="true">
                  <div className="sk relative aspect-[3/4] overflow-hidden rounded-[0.875rem]">
            ...
            : collections.map((col, i) => (
                <ScrollReveal key={col.id} delay={i * 0.1}>
                  <Link href={`/shop?collection=${col.id}`} className="group block">
                    ...
                    >
                      <div className="relative aspect-[3/4] overflow-hidden rounded-[0.875rem]">
                        <Image
                        ...
                        <div className="absolute inset-x-0 bottom-0 p-6">
                          <p className="text-xs font-medium tracking-wide text-turquoise-light">
                            {col.namePersian}
                          </p>
