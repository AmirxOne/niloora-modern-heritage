...
import { Compare, Search, ShoppingBag } from "@/components/icons";
      ...
      <header className="fixed inset-x-0 top-0 z-50 w-full">
        ...
        >
          <div className="mx-auto flex h-full max-w-[1639px] items-center px-4 md:px-8">
            ...
            {/* ━━━ موبایل: لوگو | جستجو (ناوبری اصلی در نوار پایین) ━━━ */}
            <div className="flex w-full items-center justify-between gap-3 lg:hidden">
              ...
              <button
                type="button"
                onClick={openSearch}
                className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full text-[#78716C] transition-colors active:scale-95 hover:bg-[#F5F3EF]"
